...
|----------|--------|-------|-----------|---------|
| `curl_json` | 18,904 tk | 36 tk | **-100%** | 944 µs |
| `az_json` | 23,479 tk | 74 tk | **-100%** | 558 µs |
| `summarize_huge` | 82,257 tk | 467 tk | **-99%** | 83.0 ms |
| `xcode_build` | 1,881 tk | 17 tk | **-99%** | 70 µs |
| `go_test_ndjson_failures` | 7,176 tk | 106 tk | **-99%** | 810 µs |
| `read_reread_distant` | 717 tk | 17 tk | **-98%** | 8.3 ms |
| `repetitive_output` | 4,692 tk | 134 tk | **-97%** | 229 µs |
| `pytest_failures` | 3,402 tk | 108 tk | **-97%** | 122 µs |
| `jest_json_failures` | 5,643 tk | 218 tk | **-96%** | 545 µs |
| `ps_aux` | 40,373 tk | 2,338 tk | **-94%** | 844 µs |
| `cargo_test_failures` | 1,934 tk | 157 tk | **-92%** | 55 µs |
| `git_log_200` | 2,692 tk | 275 tk | **-90%** | 203 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 38 µs |
| `eslint_json_failures` | 1,553 tk | 233 tk | **-85%** | 205 µs |
| `high_context_adaptive` | 4,418 tk | 729 tk | **-84%** | 2.6 ms |
| `cargo_build_noisy` | 2,106 tk | 439 tk | **-79%** | 252 µs |
| `docker_logs` | 665 tk | 181 tk | **-73%** | 50 µs |
| `curl_html_response` | 2,181 tk | 626 tk | **-71%** | 73 µs |
| `git_status` | 50 tk | 16 tk | **-68%** | 12 µs |
| `ruff_json_failures` | 1,261 tk | 494 tk | **-61%** | 205 µs |
...
| `ls_la` | 1,782 tk | 872 tk | **-51%** | 41 µs |
| `agent_directory_output` | 3,348 tk | 1,937 tk | **-42%** | 717 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 26 µs |
| `agent_heavy` | 2,306 tk | 1,514 tk | **-34%** | 944 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 95 µs |
| `find_deep` | 424 tk | 279 tk | **-34%** | 26 µs |
| `adversarial_tiny_output` | 4 tk | 3 tk | **-25%** | 7 µs |
| `md_prose` | 187 tk | 142 tk | **-24%** | 194 µs |
| `md_claude_md` | 316 tk | 270 tk | **-15%** | 300 µs |
| `claude_md_overhead` | 717 tk | 635 tk | **-11%** | 27 µs |
| `next_build_output` | 902 tk | 884 tk | **-2%** | 73 µs |
| `git_diff` | 502 tk | 497 tk | **-1%** | 34 µs |
| `jest_failures` | 451 tk | 448 tk | **-1%** | 44 µs |
| `state_first_simulation` | 182 tk | 181 tk | **-1%** | 11 µs |
| `kubectl_pods` | 1,513 tk | 1,513 tk | **-0%** | 47 µs |
