...
| `az_json` | 23,479 tk | 74 tk | **-100%** | 523 µs |
| `summarize_huge` | 82,257 tk | 467 tk | **-99%** | 79.8 ms |
| `xcode_build` | 1,881 tk | 17 tk | **-99%** | 78 µs |
| `go_test_ndjson_failures` | 7,176 tk | 106 tk | **-99%** | 812 µs |
| `read_reread_distant` | 717 tk | 17 tk | **-98%** | 7.5 ms |
| `repetitive_output` | 4,692 tk | 134 tk | **-97%** | 232 µs |
| `pytest_failures` | 3,402 tk | 108 tk | **-97%** | 131 µs |
| `jest_json_failures` | 5,643 tk | 218 tk | **-96%** | 577 µs |
| `ps_aux` | 40,373 tk | 2,338 tk | **-94%** | 911 µs |
| `cargo_test_failures` | 1,934 tk | 157 tk | **-92%** | 57 µs |
| `git_log_200` | 2,692 tk | 275 tk | **-90%** | 260 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 39 µs |
| `eslint_json_failures` | 1,553 tk | 233 tk | **-85%** | 212 µs |
...
| `curl_html_response` | 2,181 tk | 626 tk | **-71%** | 77 µs |
| `git_status` | 50 tk | 16 tk | **-68%** | 13 µs |
| `ruff_json_failures` | 1,261 tk | 494 tk | **-61%** | 218 µs |
| `verbose_app_log` | 4,957 tk | 1,978 tk | **-60%** | 617 µs |
| `npm_install` | 524 tk | 218 tk | **-58%** | 50 µs |
| `crosscall_redundancy_3x` | 486 tk | 222 tk | **-54%** | 52.2 ms |
| `ls_la` | 1,782 tk | 872 tk | **-51%** | 43 µs |
| `agent_directory_output` | 3,348 tk | 1,937 tk | **-42%** | 744 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 26 µs |
| `agent_heavy` | 2,306 tk | 1,514 tk | **-34%** | 520 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 98 µs |
| `find_deep` | 424 tk | 279 tk | **-34%** | 27 µs |
| `adversarial_tiny_output` | 4 tk | 3 tk | **-25%** | 7 µs |
| `md_prose` | 187 tk | 142 tk | **-24%** | 206 µs |
| `md_claude_md` | 316 tk | 270 tk | **-15%** | 248 µs |
| `claude_md_overhead` | 717 tk | 635 tk | **-11%** | 30 µs |
| `next_build_output` | 902 tk | 884 tk | **-2%** | 82 µs |
| `git_diff` | 502 tk | 497 tk | **-1%** | 35 µs |
| `jest_failures` | 451 tk | 448 tk | **-1%** | 46 µs |
