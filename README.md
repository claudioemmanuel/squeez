...
|----------|--------|-------|-----------|---------|
| `summarize_huge` | 82,257 tk | 420 tk | **-99%** | 57.8 ms |
| `repetitive_output` | 4,692 tk | 37 tk | **-99%** | 205 µs |
| `xcode_build` | 1,881 tk | 17 tk | **-99%** | 56 µs |
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 814 µs |
| `agent_directory_output` | 3,348 tk | 167 tk | **-95%** | 345 µs |
| `ps_aux` | 40,373 tk | 2,338 tk | **-94%** | 4.3 ms |
| `git_log_200` | 2,692 tk | 275 tk | **-90%** | 217 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 21 µs |
| `cargo_build_noisy` | 2,106 tk | 439 tk | **-79%** | 268 µs |
...
| `verbose_app_log` | 4,957 tk | 1,978 tk | **-60%** | 295 µs |
| `npm_install` | 524 tk | 218 tk | **-58%** | 67 µs |
| `crosscall_redundancy_3x` | 486 tk | 237 tk | **-51%** | 51.9 ms |
| `ls_la` | 1,782 tk | 872 tk | **-51%** | 215 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 27 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 107 µs |
| `agent_heavy` | 2,306 tk | 1,551 tk | **-33%** | 343 µs |
| `md_prose` | 187 tk | 138 tk | **-26%** | 848 µs |
| `md_claude_md` | 316 tk | 247 tk | **-22%** | 1.1 ms |
| `claude_md_overhead` | 717 tk | 635 tk | **-11%** | 20 µs |
| `git_diff` | 502 tk | 497 tk | **-1%** | 42 µs |
| `jest_failures` | 451 tk | 448 tk | **-1%** | 55 µs |
