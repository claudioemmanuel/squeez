...
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 1.2 ms |
| `ps_aux` | 40,373 tk | 2,352 tk | **-94%** | 2.6 ms |
| `git_log_200` | 2,692 tk | 289 tk | **-89%** | 201 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 27 µs |
| `cargo_build_noisy` | 2,106 tk | 452 tk | **-79%** | 239 µs |
| `docker_logs` | 665 tk | 186 tk | **-72%** | 44 µs |
| `find_deep` | 424 tk | 134 tk | **-68%** | 73 µs |
| `git_status` | 50 tk | 16 tk | **-68%** | 11 µs |
| `state_first_simulation` | 182 tk | 69 tk | **-62%** | 16 µs |
| `verbose_app_log` | 4,957 tk | 1,991 tk | **-60%** | 280 µs |
...
| `ls_la` | 1,782 tk | 886 tk | **-50%** | 196 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 22 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 92 µs |
| `agent_heavy` | 2,306 tk | 1,564 tk | **-32%** | 369 µs |
| `md_prose` | 187 tk | 138 tk | **-26%** | 645 µs |
