...
| `repetitive_output` | 4,692 tk | 37 tk | **-99%** | 200 µs |
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 802 µs |
| `ps_aux` | 40,373 tk | 2,352 tk | **-94%** | 2.7 ms |
| `git_log_200` | 2,692 tk | 289 tk | **-89%** | 212 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 27 µs |
| `cargo_build_noisy` | 2,106 tk | 452 tk | **-79%** | 242 µs |
| `docker_logs` | 665 tk | 186 tk | **-72%** | 45 µs |
| `find_deep` | 424 tk | 134 tk | **-68%** | 77 µs |
...
| `claude_md_overhead` | 717 tk | 318 tk | **-56%** | 75 µs |
| `crosscall_redundancy_3x` | 486 tk | 241 tk | **-50%** | 51.6 ms |
| `ls_la` | 1,782 tk | 886 tk | **-50%** | 202 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 24 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 97 µs |
| `agent_heavy` | 2,306 tk | 1,564 tk | **-32%** | 376 µs |
| `md_prose` | 187 tk | 138 tk | **-26%** | 629 µs |
