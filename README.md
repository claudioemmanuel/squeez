...
|----------|--------|-------|-----------|---------|
| `summarize_huge` | 82,257 tk | 467 tk | **-99%** | 79.5 ms |
| `xcode_build` | 1,881 tk | 17 tk | **-99%** | 72 µs |
| `go_test_ndjson_failures` | 7,176 tk | 106 tk | **-99%** | 948 µs |
| `repetitive_output` | 4,692 tk | 134 tk | **-97%** | 215 µs |
| `pytest_failures` | 3,402 tk | 108 tk | **-97%** | 123 µs |
| `jest_json_failures` | 5,643 tk | 218 tk | **-96%** | 561 µs |
| `ps_aux` | 40,373 tk | 2,338 tk | **-94%** | 860 µs |
| `cargo_test_failures` | 1,934 tk | 157 tk | **-92%** | 55 µs |
| `git_log_200` | 2,692 tk | 275 tk | **-90%** | 220 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 36 µs |
| `eslint_json_failures` | 1,553 tk | 233 tk | **-85%** | 284 µs |
| `high_context_adaptive` | 4,418 tk | 729 tk | **-84%** | 1.4 ms |
| `cargo_build_noisy` | 2,106 tk | 439 tk | **-79%** | 241 µs |
| `docker_logs` | 665 tk | 181 tk | **-73%** | 65 µs |
| `curl_html_response` | 2,181 tk | 626 tk | **-71%** | 86 µs |
| `git_status` | 50 tk | 16 tk | **-68%** | 12 µs |
| `ruff_json_failures` | 1,261 tk | 494 tk | **-61%** | 209 µs |
...
| `agent_directory_output` | 3,348 tk | 1,937 tk | **-42%** | 803 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 21 µs |
| `agent_heavy` | 2,306 tk | 1,514 tk | **-34%** | 543 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 98 µs |
| `find_deep` | 424 tk | 279 tk | **-34%** | 27 µs |
| `md_prose` | 187 tk | 142 tk | **-24%** | 208 µs |
| `md_claude_md` | 316 tk | 270 tk | **-15%** | 240 µs |
...
| `kubectl_pods` | 1,513 tk | 1,513 tk | **-0%** | 35 µs |
