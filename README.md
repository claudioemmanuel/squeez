...
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 804 µs |
...
| `find_deep` | 424 tk | 134 tk | **-68%** | 75 µs |
...
| `claude_md_overhead` | 717 tk | 318 tk | **-56%** | 77 µs |
...
| `agent_heavy` | 2,306 tk | 1,564 tk | **-32%** | 384 µs |
