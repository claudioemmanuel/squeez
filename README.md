...
| `az_json` | 23,479 tk | 74 tk | **-100%** | 597 µs |
| `summarize_huge` | 82,257 tk | 467 tk | **-99%** | 86.3 ms |
| `xcode_build` | 1,881 tk | 17 tk | **-99%** | 317 µs |
| `go_test_ndjson_failures` | 7,176 tk | 106 tk | **-99%** | 1.2 ms |
| `read_reread_distant` | 717 tk | 17 tk | **-98%** | 8.2 ms |
| `rsync_transfer` | 912 tk | 26 tk | **-97%** | 185 µs |
| `repetitive_output` | 4,692 tk | 134 tk | **-97%** | 401 µs |
| `pytest_failures` | 3,402 tk | 108 tk | **-97%** | 294 µs |
| `jest_json_failures` | 5,643 tk | 218 tk | **-96%** | 752 µs |
| `systemctl_status` | 732 tk | 41 tk | **-94%** | 181 µs |
| `ps_aux` | 40,373 tk | 2,338 tk | **-94%** | 1.0 ms |
| `cargo_test_failures` | 1,934 tk | 157 tk | **-92%** | 230 µs |
| `git_log_200` | 2,692 tk | 275 tk | **-90%** | 377 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 220 µs |
| `eslint_json_failures` | 1,553 tk | 233 tk | **-85%** | 412 µs |
| `pip_install` | 407 tk | 62 tk | **-85%** | 175 µs |
| `high_context_adaptive` | 4,418 tk | 729 tk | **-84%** | 1.6 ms |
| `cargo_build_noisy` | 2,106 tk | 439 tk | **-79%** | 435 µs |
| `bundle_install` | 121 tk | 28 tk | **-77%** | 148 µs |
| `docker_logs` | 665 tk | 181 tk | **-73%** | 219 µs |
| `curl_html_response` | 2,181 tk | 626 tk | **-71%** | 240 µs |
| `git_status` | 50 tk | 16 tk | **-68%** | 190 µs |
| `ruff_json_failures` | 1,261 tk | 494 tk | **-61%** | 366 µs |
| `verbose_app_log` | 4,957 tk | 1,978 tk | **-60%** | 828 µs |
| `npm_install` | 524 tk | 218 tk | **-58%** | 219 µs |
| `crosscall_redundancy_3x` | 486 tk | 222 tk | **-54%** | 52.3 ms |
| `ls_la` | 1,782 tk | 872 tk | **-51%** | 233 µs |
| `mypy_errors` | 650 tk | 349 tk | **-46%** | 164 µs |
| `shellcheck_run` | 335 tk | 187 tk | **-44%** | 148 µs |
| `agent_directory_output` | 3,348 tk | 1,937 tk | **-42%** | 938 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 176 µs |
| `agent_heavy` | 2,306 tk | 1,514 tk | **-34%** | 678 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 264 µs |
| `find_deep` | 424 tk | 279 tk | **-34%** | 186 µs |
| `adversarial_tiny_output` | 4 tk | 3 tk | **-25%** | 151 µs |
| `md_prose` | 187 tk | 142 tk | **-24%** | 132 µs |
| `md_claude_md` | 316 tk | 270 tk | **-15%** | 229 µs |
| `claude_md_overhead` | 717 tk | 635 tk | **-11%** | 179 µs |
| `next_build_output` | 902 tk | 884 tk | **-2%** | 236 µs |
| `git_diff` | 502 tk | 497 tk | **-1%** | 210 µs |
| `jest_failures` | 451 tk | 448 tk | **-1%** | 221 µs |
| `state_first_simulation` | 182 tk | 181 tk | **-1%** | 165 µs |
| `kubectl_pods` | 1,513 tk | 1,513 tk | **-0%** | 210 µs |
| `adversarial_dense_json` | 485 tk | 485 tk | **-0%** | 167 µs |
| `adversarial_reread_tiny` | 4 tk | 4 tk | **-0%** | 5.5 ms |
