...
| `cargo_build_noisy` | 2,106 tk | 452 tk | **-79%** | 252 µs |
...
| `verbose_app_log` | 4,957 tk | 1,991 tk | **-60%** | 307 µs |
| `npm_install` | 524 tk | 232 tk | **-56%** | 48 µs |
| `claude_md_overhead` | 717 tk | 318 tk | **-56%** | 76 µs |
| `crosscall_redundancy_3x` | 486 tk | 241 tk | **-50%** | 51.6 ms |
| `ls_la` | 1,782 tk | 886 tk | **-50%** | 215 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 24 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 103 µs |
| `agent_heavy` | 2,306 tk | 1,564 tk | **-32%** | 402 µs |
