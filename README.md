...
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 826 µs |
| `agent_directory_output` | 3,348 tk | 167 tk | **-95%** | 337 µs |
| `ps_aux` | 40,373 tk | 2,338 tk | **-94%** | 3.0 ms |
| `git_log_200` | 2,692 tk | 275 tk | **-90%** | 226 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 22 µs |
| `cargo_build_noisy` | 2,106 tk | 439 tk | **-79%** | 267 µs |
| `docker_logs` | 665 tk | 186 tk | **-72%** | 59 µs |
| `curl_html_response` | 2,181 tk | 626 tk | **-71%** | 47 µs |
| `find_deep` | 424 tk | 134 tk | **-68%** | 79 µs |
| `git_status` | 50 tk | 16 tk | **-68%** | 15 µs |
| `pytest_failures` | 3,402 tk | 1,175 tk | **-65%** | 318 µs |
| `verbose_app_log` | 4,957 tk | 1,978 tk | **-60%** | 308 µs |
...
| `git_copilot` | 640 tk | 421 tk | **-34%** | 108 µs |
| `agent_heavy` | 2,306 tk | 1,551 tk | **-33%** | 335 µs |
| `md_prose` | 187 tk | 138 tk | **-26%** | 872 µs |
