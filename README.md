...
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 837 µs |
| `ps_aux` | 40,373 tk | 2,352 tk | **-94%** | 2.6 ms |
| `git_log_200` | 2,692 tk | 289 tk | **-89%** | 209 µs |
