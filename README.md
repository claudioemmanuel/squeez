...
| `repetitive_output` | 4,692 tk | 37 tk | **-99%** | 213 µs |
| `high_context_adaptive` | 4,418 tk | 52 tk | **-99%** | 823 µs |
| `ps_aux` | 40,373 tk | 2,352 tk | **-94%** | 2.9 ms |
| `git_log_200` | 2,692 tk | 289 tk | **-89%** | 226 µs |
| `tsc_errors` | 731 tk | 101 tk | **-86%** | 26 µs |
| `cargo_build_noisy` | 2,106 tk | 452 tk | **-79%** | 257 µs |
...
| `verbose_app_log` | 4,957 tk | 1,991 tk | **-60%** | 303 µs |
| `npm_install` | 524 tk | 232 tk | **-56%** | 49 µs |
| `claude_md_overhead` | 717 tk | 318 tk | **-56%** | 358 µs |
| `crosscall_redundancy_3x` | 486 tk | 241 tk | **-50%** | 51.5 ms |
| `ls_la` | 1,782 tk | 886 tk | **-50%** | 214 µs |
| `env_dump` | 441 tk | 287 tk | **-35%** | 25 µs |
| `git_copilot` | 640 tk | 421 tk | **-34%** | 112 µs |
| `agent_heavy` | 2,306 tk | 1,564 tk | **-32%** | 405 µs |
| `md_prose` | 187 tk | 138 tk | **-26%** | 651 µs |
