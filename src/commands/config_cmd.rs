...
const SCHEMA: &[(&str, Kind)] = &[
    ...
    ("wrap_timeout_secs", Kind::U64),
    ("tokenizer_scale", Kind::F32),
    ("subagent_result_warn_tokens", Kind::Usize),
    ("amplification_aware", Kind::Bool),
    ("amplification_min_calls", Kind::U64),
    ("amplification_min_remaining", Kind::U64),
    ("amplification_min_call_tokens", Kind::U64),
...
fn field_value(c: &Config, key: &str) -> Option<String> {
    let v = match key {
        ...
        "wrap_timeout_secs" => c.wrap_timeout_secs.to_string(),
        "tokenizer_scale" => c.tokenizer_scale.to_string(),
        "subagent_result_warn_tokens" => c.subagent_result_warn_tokens.to_string(),
        "amplification_aware" => c.amplification_aware.to_string(),
        "amplification_min_calls" => c.amplification_min_calls.to_string(),
        "amplification_min_remaining" => c.amplification_min_remaining.to_string(),
        "amplification_min_call_tokens" => c.amplification_min_call_tokens.to_string(),
