...
### Added
- feat(buddy): slow XP 10x — 1M net tokens = 1 XP (was 100k)
- feat(buddy): own statusline — profile duck + 5h/7d/context meters
- feat(buddy): duck rides the statusline, chained with any existing HUD
- feat(buddy): /buddy command draws the duck; XP 1000x harder (100k tokens = 1 XP)
- feat(buddy): vendor pato-buddy companion, XP grows with squeez net savings
- feat(bench): --showcase, a best-case table that says it is one
- feat(bench): adversarial scenarios — measure where squeez should not win
- feat(context): session-long read dedup + dedup floor
- feat(focus): ADHD output-shaping axis, orthogonal to persona
- feat(subagent): deliver oversized-return advisory via additionalContext
- feat(browser): advisory nudge on repeated screenshot/navigate per URL
- feat(cloud,network): sniff flag-less JSON and condense deep objects
- feat(summarize): byte-size trigger for single-line JSON blobs
- feat(protocol): teach browser-verify economy and anti-self-piping
- feat(config): loud kill-switch warning and honest managed header
- feat(doctor): self-health check — hooks drift, registration, config, tracking freshness
- feat(filter-dsl): E8 story 2 -- declarative filter DSL, closes E8 and roadmap
- feat(discover): E8 story 1 -- squeez discover ranks filter-DSL candidates
- feat(persona): E6 -- prune BPE-losing letter/word substitutions
- feat(context): E4 -- stash search + vocabulary hints
- feat(wrap): E3 -- safe flag-forcing at spawn (env tier + gated arg tier)
- feat(wrap): E5 -- success collapse for zero-signal low-signal commands
- feat(reporters): E2 story 5 -- structured eslint/ruff JSON condensers, closes E2
- feat(reporters): E2 story 4 -- structured go test -json NDJSON condenser
- feat(reporters): E2 story 3 -- structured pytest text condenser
- feat(reporters): E2 story 2 -- structured jest/vitest --json condenser
- feat(reporters): E2 story 1 -- structured cargo test failures-only condenser
- feat(bench): 3-arm marginal harness, o200k_base, BPE substitution audit
- feat(context): E7 sensitive-content stash guard
- feat(wrap): E1 self-overhead diet — net-win gate on no-op calls, show_header tri-state, header tag dedup, overhead accounting
...
### Changed
- chore(release): bump version to 1.43.1 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.43.0
- chore(release): bump version to 1.43.0 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.42.1
- chore(release): bump version to 1.42.1 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.42.0
- chore(release): bump version to 1.42.0 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.41.0
- chore(release): bump version to 1.41.0 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.40.0
- chore(release): bump version to 1.40.0 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.39.0
- chore(release): bump version to 1.39.0 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.38.0
- chore(release): bump version to 1.38.0 [squeez-release-bot]
- chore(gitignore): ignore *.original.md compress-md backups
- test(benchmark): az_json, curl_json, next_build scenarios
- docs: update changelog and benchmarks for v1.37.1
- docs: update changelog and benchmarks for v1.37.1
- chore(release): bump version to 1.37.1 [squeez-release-bot]
- docs: update changelog and benchmarks for v1.37.0
- chore(release): bump version to 1.37.0 [squeez-release-bot]
- docs: document v1.35.0 features and complete the 7-host matrix (#185) (#186)
- docs: update changelog and benchmarks for v1.36.0
...
### Fixed
- fix(hosts): register hooks without python3 so setup works on Windows (#192)
- fix(doctor): treat wrapped Bash accounting as alive in freshness check (#191)
- fix(compress-md): detect document language instead of trusting config lang
- fix(economy): one-shot advisories fire once; dedup markers must pay for themselves
- fix(context): dedup marker names what it matched
- fix(calibrate): merge into existing config, preserve user keys
- fix(intensity): floor the unknown-window budget at 200K, not legacy 112K
- fix(compress-md): never auto-rewrite a git-tracked file
- fix(wrap): structured test reporters take precedence over summarize
- fix(wrap): never emit nothing when compression strips output to empty
- fix(init): banner reports real compression status, not hardcoded ON
- fix(filter): route 'next lint' to typescript handler and eslint reporter
- fix(hooks): read tool_response payload key — repair tokens_est accounting
- fix(bench): recalibrate mdcompress floor after E6 substitution prune
- fix(sensitive): E7 tier 2 -- command/path denylist warning
...
[Unreleased]: https://github.com/claudioemmanuel/squeez/compare/v1.43.1...HEAD
...
[1.37.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.37.0
[1.37.1]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.37.1
[1.38.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.38.0
[1.39.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.39.0
[1.40.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.40.0
[1.41.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.41.0
[1.42.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.42.0
[1.42.1]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.42.1
[1.43.0]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.43.0
[1.43.1]: https://github.com/claudioemmanuel/squeez/releases/tag/v1.43.1
